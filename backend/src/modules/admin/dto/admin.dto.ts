...
import { IsArray, IsBoolean, IsEmail, IsNotEmpty, IsObject, IsOptional, IsString } from 'class-validator';
...
export class UpdateSystemSettingsDto {
  @ApiProperty({ type: 'object', additionalProperties: true }) @IsObject() settings: Record<string, unknown>;
}
